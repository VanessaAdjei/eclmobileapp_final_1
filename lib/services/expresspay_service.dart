...
class ExpressPayApi {
  ...
  Function(bool paymentSuccessful, dynamic jsonObject, String message)? _queryCompletionListener;
  ...
  Future<void> query(String token) async {
    try {
      ...
      if (_queryCompletionListener != null) {
        _queryCompletionListener!(success, responseData, responseData['message'] ?? '');
      }
    } catch (e) {
...
class _MainActivityState extends State<MainActivity> {
  ...
  void initState() {
    ...
    expressPayApi.setPaymentCompletionListener(onExpressPayPaymentFinished as Function(bool p1, String p2));
  }
  ...
  void onExpressPayPaymentFinished(BuildContext context, bool paymentCompleted, String message) {
    if (paymentCompleted) {
